 ...
 */
goog.provide('ng.material.libs.textField');
...
/**
 * @ngdoc module
 * @name material.libs.textField
 * @description
 * Form
 */
ng.material.libs.textField = angular.module('material.libs.textField', [
  'material.core'
])
  ...
  return {
    ...
    compile : function(element, attr) {
      ...
      $log.warn('<md-text-float> is deprecated. Please use `<md-input-container>` and `<input>`.' + 
                'More information at http://material.angularjs.org/#/api/material.libs.input/directive/mdInputContainer');

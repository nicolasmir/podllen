...
under `/bower_libs/angular-material/`.
...
<head>
    <meta name="viewport" content="initial-scale=1, maximum-scale=1, user-scalable=no" />
    <link rel="stylesheet" href="/bower_libs/angular-material/angular-material.css">
</head>
	<body ng-app="YourApp">
	...
	<script src="/bower_libs/angular/angular.js"></script>
	<script src="/bower_libs/angular-aria/angular-aria.js"></script>
	<script src="/bower_libs/angular-animate/angular-animate.js"></script>
	<script src="/bower_libs/angular-material/angular-material.js"></script>
	<script>

...
angular.module('ngMaterial', ["ng","ngAnimate","ngAria","material.core","material.core.gestures","material.core.layout","material.core.theming.palette","material.core.theming","material.core.animate","material.libs.autocomplete","material.libs.backdrop","material.libs.bottomSheet","material.libs.button","material.libs.card","material.libs.checkbox","material.libs.chips","material.libs.content","material.libs.datepicker","material.libs.dialog","material.libs.divider","material.libs.fabActions","material.libs.fabShared","material.libs.fabSpeedDial","material.libs.fabToolbar","material.libs.fabTrigger","material.libs.gridList","material.libs.icon","material.libs.input","material.libs.list","material.libs.menu","material.libs.menuBar","material.libs.progressCircular","material.libs.progressLinear","material.libs.radioButton","material.libs.select","material.libs.showHide","material.libs.sidenav","material.libs.slider","material.libs.sticky","material.libs.subheader","material.libs.swipe","material.libs.switch","material.libs.tabs","material.libs.toast","material.libs.toolbar","material.libs.tooltip","material.libs.virtualRepeat","material.libs.whiteframe"]);
})();
(function(){
"use strict";
...
/**
 * @ngdoc module
 * @name material.libs.autocomplete
 */
/*
 * @see js folder for autocomplete implementation
 */
angular.module('material.libs.autocomplete', [
  'material.core',
  'material.libs.icon',
  'material.libs.virtualRepeat'
]);
 ...
 * @ngdoc directive
 * @name mdBackdrop
 * @module material.libs.backdrop
 *
 * @restrict E
 *
 * @description
 * `<md-backdrop>` is a backdrop element used by other libs, such as dialog and bottom sheet.
 * Apply class `opaque` to make the backdrop use the theme backdrop color.
 *
 */

angular
  .module('material.libs.backdrop', ['material.core'])
...
/**
 * @ngdoc module
 * @name material.libs.bottomSheet
 * @description
 * BottomSheet
 */
angular
  .module('material.libs.bottomSheet', [
    'material.core',
    'material.libs.backdrop'
  ])
...
/**
 * @ngdoc module
 * @name material.libs.button
 * @description
 *
 * Button
 */
angular
    .module('material.libs.button', [ 'material.core' ])
    .directive('mdButton', MdButtonDirective);

/**
 * @ngdoc directive
 * @name mdButton
 * @module material.libs.button
 *
 * @restrict E
 *
 * @description
...
/**
 * @ngdoc module
 * @name material.libs.card
 *
 * @description
 * Card libs.
 */
angular.module('material.libs.card', [
    'material.core'
  ])
...
/**
 * @ngdoc module
 * @name material.libs.checkbox
 * @description Checkbox module!
 */
angular
  .module('material.libs.checkbox', ['material.core'])
  .directive('mdCheckbox', MdCheckboxDirective);

/**
 * @ngdoc directive
 * @name mdCheckbox
 * @module material.libs.checkbox
 * @restrict E
 *
 * @description
...
/**
 * @ngdoc module
 * @name material.libs.chips
 */
/*
 * @see js folder for chips implementation
 */
angular.module('material.libs.chips', [
  'material.core',
  'material.libs.autocomplete'
]);
...
/**
 * @ngdoc module
 * @name material.libs.content
 *
 * @description
 * Scrollable content
 */
angular.module('material.libs.content', [
  'material.core'
])
...
(function() {
  ...
  /**
   * @ngdoc module
   * @name material.libs.datepicker
   * @description Datepicker
   */
  angular.module('material.libs.datepicker', [
    'material.core',
    'material.libs.icon',
    'material.libs.virtualRepeat'
...
(function() {
   ...
   *     };
   *
   *     // In addition to date display, date libs also need localized messages
  ...
  angular.module('material.libs.datepicker').config(["$provide", function($provide) {
...
(function() {
   ...
   * datepicker.
   */
  angular.module('material.libs.datepicker').factory('$$mdDateUtil', function() {
    return {
...
/**
 * @ngdoc module
 * @name material.libs.dialog
 */
angular
  .module('material.libs.dialog', [
    'material.core',
    'material.libs.backdrop'
  ])
...
/**
 * @ngdoc module
 * @name material.libs.divider
 * @description Divider module!
 */
angular.module('material.libs.divider', [
  'material.core'
])
...
(function() {
  ...
  /**
   * @ngdoc module
   * @name material.libs.fabActions
   */
  angular
    .module('material.libs.fabActions', ['material.core'])
    .directive('mdFabActions', MdFabActionsDirective);

  /**
   * @ngdoc directive
   * @name mdFabActions
   * @module material.libs.fabActions
   *
   * @restrict E
   *
   * @description
...
(function() {
  ...
  angular.module('material.libs.fabShared', ['material.core'])
...
(function() {
  ...
  /**
   * @ngdoc module
   * @name material.libs.fabSpeedDial
   */
  angular
    // Declare our module
    .module('material.libs.fabSpeedDial', [
      'material.core',
      'material.libs.fabShared',
      'material.libs.fabTrigger',
      'material.libs.fabActions'
    ])
...
(function() {
  ...
  /**
   * @ngdoc module
   * @name material.libs.fabToolbar
   */
  angular
    // Declare our module
    .module('material.libs.fabToolbar', [
      'material.core',
      'material.libs.fabShared',
      'material.libs.fabTrigger',
      'material.libs.fabActions'
...
/**
 * @ngdoc module
 * @name material.libs.gridList
 */
angular.module('material.libs.gridList', ['material.core'])
 ...
 *
 * <img src="//material-design.storage.googleapis.com/publish/v_2/material_ext_publish/0Bx4BSt6jniD7OVlEaXZ5YmU1Xzg/libs_grids_usage2.png"
 *    style="width: 300px; height: auto; margin-right: 16px;" alt="Concept of grid explained visually">
 * <img src="//material-design.storage.googleapis.com/publish/v_2/material_ext_publish/0Bx4BSt6jniD7VGhsOE5idWlJWXM/libs_grids_usage3.png"
...
/**
 * @ngdoc module
 * @name material.libs.icon
 * @description
 * Icon
 */
angular.module('material.libs.icon', [
    'material.core'
  ]);
...
/**
 * @ngdoc module
 * @name material.libs.input
 */

angular.module('material.libs.input', [
    'material.core'
  ])
...
/**
 * @ngdoc module
 * @name material.libs.list
 * @description
 * List module
 */
angular.module('material.libs.list', [
  'material.core'
])
...
/**
 * @ngdoc module
 * @name material.libs.menu
 */

angular.module('material.libs.menu', [
  'material.core',
  'material.libs.backdrop'
]);
...
/**
 * @ngdoc module
 * @name material.libs.menu-bar
 */

angular.module('material.libs.menuBar', [
  'material.core',
  'material.libs.menu'
]);
...
/**
 * @ngdoc module
 * @name material.libs.progressCircular
 * @description Circular Progress module!
 */
angular.module('material.libs.progressCircular', [
  'material.core'
])
 ...
 * @module material.libs.progressCircular
 * @restrict E
 *
* @description
...
/**
 * @ngdoc module
 * @name material.libs.progressLinear
 * @description Linear Progress module!
 */
angular.module('material.libs.progressLinear', [
  'material.core'
])
 ...
 * @module material.libs.progressLinear
 * @restrict E
 *
 * @description
...
/**
 * @ngdoc module
 * @name material.libs.radioButton
 * @description radioButton module!
 */
angular.module('material.libs.radioButton', [
  'material.core'
])
...
/**
 * @ngdoc directive
 * @module material.libs.radioButton
 * @name mdRadioGroup
 *
 * @restrict E
 *
...
angular.module('material.libs.select', [
    'material.core',
    'material.libs.backdrop'
  ])
...
/**
 * @ngdoc module
 * @name material.libs.sidenav
 *
 * @description
 * A Sidenav QP component.
 */
angular
  .module('material.libs.sidenav', [
    'material.core',
    'material.libs.backdrop'
  ])
...
"use strict";
  ...
  /**
   * @ngdoc module
   * @name material.libs.slider
   */
  angular.module('material.libs.slider', [
    'material.core'
  ])
...
/**
 * @ngdoc module
 * @name material.libs.sticky
 * @description
 * Sticky effects for md
 *
 */
angular
  .module('material.libs.sticky', [
    'material.core',
    'material.libs.content'
  ])
 ...
 *  Design Specifications](https://www.google.com/design/spec/libs/subheaders.html)
 *
 *  > To improve the visual grouping of content, use the system color for your subheaders.
 *
 */
angular
  .module('material.libs.subheader', [
    'material.core',
    'material.libs.sticky'
  ])
...
/**
 * @ngdoc module
 * @name material.libs.swipe
 * @description Swipe module!
 */
/**
 * @ngdoc directive
 * @module material.libs.swipe
 * @name mdSwipeLeft
 *
 * @restrict A
 *
...
angular.module('material.libs.swipe', ['material.core'])
 ...
 * @private
 * @ngdoc module
 * @name material.libs.switch
 */

angular.module('material.libs.switch', [
  'material.core',
  'material.libs.checkbox'
])
 ...
 */
angular.module('material.libs.tabs', [
  'material.core',
  'material.libs.icon'
]);
...
/**
  * @ngdoc module
  * @name material.libs.toast
  * @description
  * Toast
  */
angular.module('material.libs.toast', [
  'material.core',
  'material.libs.button'
])
...
/**
 * @ngdoc module
 * @name material.libs.toolbar
 */
angular.module('material.libs.toolbar', [
  'material.core',
  'material.libs.content'
])
...
/**
 * @ngdoc module
 * @name material.libs.tooltip
 */
angular
    .module('material.libs.tooltip', [ 'material.core' ])
    .directive('mdTooltip', MdTooltipDirective);

/**
 * @ngdoc directive
 * @name mdTooltip
 * @module material.libs.tooltip
 * @description
...
/**
 * @ngdoc module
 * @name material.libs.virtualRepeat
 */
angular.module('material.libs.virtualRepeat', [
  'material.core',
  'material.libs.showHide'
])
 ...
 * @module material.libs.virtualRepeat
 * @restrict E
 * @description
...
/**
 * @ngdoc module
 * @name material.libs.whiteframe
 */
angular.module('material.libs.whiteframe', []);
...
angular
    .module('material.libs.autocomplete')
 ...
 * the models of various input libs.
 *
 * @param $scope
 * @param $mdConstant
 * @param $log
...
"use strict";
  ...
  function MdChips ($mdTheming, $mdUtil, $compile, $log, $timeout) {
     ...
     *
     * Building the template involves 3 key libs:
     * static chips
     * chip template
     * input control
     *
 ...
 * See the [Material Design Spec](http://www.google.com/design/spec/libs/menus.html#menus-specs)
 ...
 *
 * @description
 * The `<md-tabs>` directive serves as the container for 1..n `<md-tab>` child directives to produces a Tabs libs.
 ...
 *
 * **Tab-only** support is useful when tab buttons are used for custom navigation regardless of any other libs, content, or views.

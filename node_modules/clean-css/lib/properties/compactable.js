...
// Possible options:
//
// * libs: array (Only specify for shorthand properties.)
...
//   For shorthand, this is used when every component is set to its default value, therefore it should be the shortest possible default value of all the libs.
//
...
//   Breaks the shorthand up to its libs.
//
// * restore: function (Only specify for shorthand properties.)
//   Puts the shorthand together from its libs.
//
var compactable = {
  'color': {
...
var addFourValueShorthand = function (prop, libs, options) {
  options = options || {};
  compactable[prop] = {
...
for (var property in compactable) {
  if (compactable[property].shorthand) {
    for (var i = 0, l = compactable[property].libs.length; i < l; i++) {
      compactable[compactable[property].libs[i]].componentOf = property;
    }
  }
}
